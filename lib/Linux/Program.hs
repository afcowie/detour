...
--
-- Originally cloned from Vaultaire.Program in vaultaire-common for study and
-- experimentation. Please contribute changes back to that shared library
-- should they be broadly applicable.
--

--
-- | Common program initalization for binaries
--
module Linux.Program
(
    initializeProgram,
    Verbosity(..)
)
